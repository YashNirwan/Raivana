...
const RAIVANA_PRODUCTS = [
  ...
  },
  {
    ...
    category: "woodwork",
    subcategory: "Cabinets",
    description: "A wide three-door sideboard in solid mango wood, dipped in a mature, powdery dusty rose. Over 12 to 15 days, master carvers chisel an elephant on each side door and a fanned peacock on the centre, with two drawers of carved floral vines above and round knobs. The pink is distressed by hand so it reads sun-faded like old palace walls. At console height it works as a buffet, TV unit, entryway cabinet or dresser. Storage is 2 drawers plus a 3-door cabinet with adjustable shelves inside.",
    price_inr: 48000,
    price_inr_export: 75000,
    variants: null,
    details: { color: "Dusty Rose / Blush Pink, distressed", material: "100% Solid Mango Wood, hand-carved", craft: "Deep relief carving of elephant, peacock and floral motifs", hardware: "Drop handles and round knobs", storage: "2 drawers and 3 doors with adjustable shelves", size: "48 × 36 × 18 in / 122 × 91 × 46 cm" },
    weight_g: 55000,
  ...
  },
  {
    ...
    category: "woodwork",
    subcategory: "Cabinets",
    description: "Built from premium seasoned teak, this long, low sideboard is hand-carved with deep lotus medallions across all three doors, each flower pulled out of the wood so shadows fall into the petals. Three drawers above carry scrolling vine and flower carving. No paint, just time and the natural oils of teak that keep it stable. On bracket feet it works as a dining buffet, TV console, entryway storage, dresser or bar cabinet. Storage is 3 drawers and 3 doors with an adjustable shelf.",
    price_inr: 82000,
    price_inr_export: 140000,
    variants: null,
    details: { material: "Solid Seasoned Teak Wood", craft: "Deep relief lotus medallion and vine carving", hardware: "Ring pulls and knob latches", storage: "3 drawers, 3 doors with adjustable shelf, bracket feet", finish: "Natural, no paint", size: "36 × 60 × 18 in / 91 × 152 × 46 cm" },
    weight_g: 60000,
