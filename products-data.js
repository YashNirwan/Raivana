...
const RAIVANA_PRODUCTS = [
  ...
  // Sal Wood Mirrors
  {
    ...
    subtitle: "Distressed White Arch · Sal Wood",
    category: "woodwork",
    subcategory: "Wooden Home Decor",
    description: "Crisp distressed white with a regal arched top and floral relief. Clean, timeless, and versatile for modern or rustic interiors. Handmade in sal wood, built to last and made to be admired.",
    price_inr: 18500,
    price_inr_export: 28500,
    variants: null,
    details: { material: "Sal Wood", finish: "Distressed White", size: "3 × 5 feet", craft: "Hand-carved floral relief" },
    weight_g: 7000,
  ...
  },
  {
    ...
    subtitle: "Blush Pink Vine Arch · Sal Wood",
    category: "woodwork",
    subcategory: "Wooden Home Decor",
    description: "A romantic blush pink frame with an arched silhouette and intricate vine motifs. Adds warmth and grace to light, airy spaces. Handmade in sal wood with traditional carving techniques passed down generations.",
    price_inr: 18500,
    price_inr_export: 28500,
    variants: null,
    details: { material: "Sal Wood", finish: "Blush Pink", size: "3 × 5 feet", craft: "Hand-carved vine motifs" },
    weight_g: 7000,
  ...
  },
  {
    ...
    subtitle: "Butter Yellow Arched Frame · Sal Wood",
    category: "woodwork",
    subcategory: "Wooden Home Decor",
    description: "Warm butter-yellow tones meet classic arched carvings for a mirror that feels both vintage and fresh. The floral border frames light beautifully. Handmade in sal wood, each piece carries unique artisan detail.",
    price_inr: 18500,
    price_inr_export: 28500,
    variants: null,
    details: { material: "Sal Wood", finish: "Butter Yellow", size: "3 × 5 feet", craft: "Hand-carved floral border" },
    weight_g: 7000,
  ...
  },
  {
    ...
    subtitle: "Powder Blue Floral Arch · Sal Wood",
    category: "woodwork",
    subcategory: "Wooden Home Decor",
    description: "A soft powder-blue arch framed with delicate floral carvings. The pillar details bring a calm, heritage charm to any wall. Handmade in sal wood by skilled artisans. Perfect for entryways or bedroom dressing corners.",
    price_inr: 18500,
    price_inr_export: 28500,
    variants: null,
    details: { material: "Sal Wood", finish: "Powder Blue", size: "3 × 5 feet", craft: "Hand-carved floral arch" },
    weight_g: 7000,
  ...
  },
  {
    ...
    subtitle: "Mint Jharoka with Twin Pillars · Sal Wood",
    category: "woodwork",
    subcategory: "Wooden Home Decor",
    description: "A soft mint jharoka frame with hand-carved floral vines and twin pillars. The scalloped arch adds that old-palace charm to any wall. Handmade in sal wood by skilled artisans. Each piece carries unique carving details, so no two are exactly alike.",
    price_inr: 18500,
    price_inr_export: 28500,
    variants: null,
    details: { material: "Sal Wood", finish: "Mint Green", size: "3 × 5 feet", craft: "Hand-carved floral vines" },
    weight_g: 7000,
  ...
  },
  {
    ...
    subtitle: "Blush Pink Haveli Arch · Sal Wood",
    category: "woodwork",
    subcategory: "Wooden Home Decor",
    description: "A blush pink arched mirror with a scalloped crown and delicate floral carvings across the top. The distressed panel details on the sides give it that vintage haveli charm. Perfect for bedrooms, dressing areas, or as a wall accent. Handmade in sal wood by skilled artisans. Each piece has natural variations, making it one of a kind.",
    price_inr: 25000,
    price_inr_export: 38000,
    variants: null,
    details: { material: "Sal Wood", finish: "Blush Pink with Distressing", size: "2 × 5 feet", craft: "Hand-carved floral arch" },
    weight_g: 5000,
  ...
  },
  {
    ...
    subtitle: "Firoza Blue Sunray Arch · Sal Wood",
    category: "woodwork",
    subcategory: "Wooden Home Decor",
    description: "A bold firoza blue frame with a deep arched cut and hand-carved sunray and floral detailing all around. The distressed finish gives it that old-world haveli vibe. Handmade in sal wood by skilled artisans. Each carving is unique, so every mirror has its own character.",
    price_inr: 28500,
    price_inr_export: 45000,
    variants: null,
    details: { material: "Sal Wood", finish: "Firoza Blue Distressed", size: "3 × 5 feet", craft: "Hand-carved sunray and floral detailing" },
    weight_g: 7000,
  ...
  },
  {
    ...
    subtitle: "Teal & Gold Palace Arch · Sal Wood",
    category: "woodwork",
    subcategory: "Wooden Home Decor",
    description: "A teal-and-gold mirror frame with deep arch carvings and intricate floral scrollwork. The distressed finish makes it feel like it's from an old Rajasthani palace. Perfect as a statement wall piece or leaning in a hallway. Handmade in sal wood by skilled artisans. Each carving is unique, so no two frames are exactly the same.",
    price_inr: 32500,
    price_inr_export: 52000,
    variants: null,
    details: { material: "Sal Wood", finish: "Teal with Gold Detailing", size: "3 × 6 feet", craft: "Hand-carved floral scrollwork" },
    weight_g: 10000,
  ...
  },
  {
    ...
    subtitle: "Deep Teal with Gold-Leaf Vines · Sal Wood",
    category: "woodwork",
    subcategory: "Wooden Home Decor",
    description: "A deep teal frame with a cusped arch and carved pillars. Delicate gold-leaf vines and brass-finished flower medallions are hand-carved across the top, bottom, and arch border. The distressed teal finish with gold highlights gives it a rich, antique haveli feel. Handmade in sal wood by skilled artisans. Every vine and bloom is hand-carved, so the gold detailing sits uniquely on each frame.",
    price_inr: 28000,
    price_inr_export: 42000,
    variants: null,
    details: { material: "Sal Wood", finish: "Deep Teal with Gold Leaf", size: "3 × 5 feet", craft: "Hand-carved gold-leaf vine detailing" },
    weight_g: 7000,
  ...
  },
  {
    ...
    subtitle: "Blush Pink Cusped Arch with Gold · Sal Wood",
    category: "woodwork",
    subcategory: "Wooden Home Decor",
    description: "A soft blush pink frame with a cusped arch and twin carved pillars. Hand-carved floral vines with gold highlights run across the top and bottom for a royal haveli feel. Looks stunning over console tables or in sunlit corners. Handmade in sal wood by skilled artisans. The distressed gold finish makes each carving stand out uniquely.",
    price_inr: 22000,
    price_inr_export: 32000,
    variants: null,
    details: { material: "Sal Wood", finish: "Blush Pink with Gold Highlights", size: "3 × 5 feet", craft: "Hand-carved floral vines with gold" },
    weight_g: 7000,
    images: ["img/nc130-1.webp", "img/nc130-2.webp"]
  },
  {
    id: 131,
    name: "Sage Gulzar Mirror",
    subtitle: "Muted Sage with Pink Floral Border · Sal Wood",
    category: "woodwork",
    subcategory: "Wooden Home Decor",
    description: "A muted sage frame with a cusped arch and carved pillars. Delicate pink floral blooms and ivory vines are hand-carved across the top, bottom, and arch border for a subtle garden effect. The distressed finish makes it perfect for pastel, boho, or heritage spaces. Handmade in sal wood by skilled artisans. Every flower and vine is hand-carved, so the soft color variations are unique to each frame.",
    price_inr: 25000,
    price_inr_export: 35000,
    variants: null,
    details: { material: "Sal Wood", finish: "Muted Sage with Pink Florals", size: "3 × 5 feet", craft: "Hand-carved floral vine border" },
    weight_g: 7000,
  ...
  },
  {
    ...
    subtitle: "Powder Blue Cusped Arch with Ivory · Sal Wood",
    category: "woodwork",
    subcategory: "Wooden Home Decor",
    description: "A serene powder-blue frame with a cusped arch and fluted pillars. Ivory vines and large floral medallions are hand-carved across the top, bottom, and arch, with gold accents catching the light. The distressed finish gives it that old haveli feel without feeling heavy. Handmade in sal wood by skilled artisans. Each floral and vine detail is hand-carved, making the gold highlights sit uniquely on every frame.",
    price_inr: 22000,
    price_inr_export: 32000,
    variants: null,
    details: { material: "Sal Wood", finish: "Powder Blue with Gold Accents", size: "3 × 5 feet", craft: "Hand-carved ivory vine medallions" },
    weight_g: 7000,
  ...
  },
  {
    ...
    subtitle: "Mint & Gold Jharoka Frame · Sal Wood",
    category: "woodwork",
    subcategory: "Wooden Home Decor",
    ...
    price_inr_export: 32000,
    variants: null,
    details: { material: "Sal Wood", finish: "Mint with Antique Gold", size: "3 × 5 feet", craft: "Hand-carved florals and vines" },
    weight_g: 7000,
  ...
  },
  {
    ...
    subtitle: "Butter Yellow Cusped Arch · Sal Wood",
    category: "woodwork",
    subcategory: "Wooden Home Decor",
    description: "A warm butter-yellow frame with a cusped arch and carved pillars. Intricate floral vines and large bloom medallions are hand-carved across the top, bottom, and arch border, with a soft pink inner outline adding a delicate touch. The light finish makes it perfect for bright, airy spaces and pastel interiors. Handmade in sal wood by skilled artisans. Every flower and leaf is hand-carved, so the subtle pink and gold tones vary slightly on each piece.",
    price_inr: 25000,
    price_inr_export: 35000,
    variants: null,
    details: { material: "Sal Wood", finish: "Butter Yellow with Pink Outline", size: "3 × 5 feet", craft: "Hand-carved floral vine arch" },
    weight_g: 7000,
  ...
  },
  {
    ...
    subtitle: "White Twin Cusped Arch · Sal Wood",
    category: "woodwork",
    subcategory: "Wooden Home Decor",
    description: "A crisp white frame with 2 cusped arches divided by a carved pillar. The top has a scale and floral medallion pattern, and the pillars are detailed with lotus motifs. The clean finish makes it perfect for boho, minimal, or coastal homes. Looks gorgeous above painted consoles or in bright corners. Handmade in sal wood by skilled artisans. Each scale and floral carving is done by hand, giving every mirror a unique texture.",
    price_inr: 22500,
    price_inr_export: 32000,
    variants: null,
    details: { material: "Sal Wood", finish: "Crisp White", size: "4 × 5 feet", craft: "Hand-carved twin arch with lotus motifs" },
    weight_g: 10000,
  ...
  },
  {
    ...
    subtitle: "Aged Turquoise Relief Carvings · Sal Wood",
    category: "woodwork",
    subcategory: "Wooden Home Decor",
    description: "An aged turquoise frame with deep relief carvings of scrolling vines and large floral medallions. The cusped arch and layered border give it a weathered, old-world charm. Pairs beautifully with painted walls and heritage interiors. Handmade in sal wood by skilled artisans. The verdigris finish is applied by hand, so every carving catches light differently.",
    price_inr: 23500,
    price_inr_export: 32000,
    variants: null,
    details: { material: "Sal Wood", finish: "Aged Turquoise Verdigris", size: "3 × 4 feet", craft: "Deep relief carved vines and medallions" },
    weight_g: 5000,
  ...
  },
  {
    ...
    subtitle: "Bottle Green with Painted Peacocks · Sal Wood",
    category: "woodwork",
    subcategory: "Wooden Home Decor",
    description: "A bottle-green frame with an ivory border hand-painted with pink lotus, green leaves, and twin peacocks on either side of the cusped arch. The dot border and gold outline add a delicate, festive touch. Perfect for bringing heritage color and art to any wall. Handmade in sal wood by skilled artisans. Each peacock feather and lotus bloom is hand-painted, making every piece one of a kind.",
    price_inr: 14000,
    price_inr_export: 25000,
    variants: null,
    details: { material: "Sal Wood", finish: "Bottle Green with Ivory Border", size: "2 × 3 feet", craft: "Hand-painted peacock and lotus motifs" },
    weight_g: 3000,
  ...
  },
  {
    ...
    subtitle: "Ivory with Red Lotus Painting · Sal Wood",
    category: "woodwork",
    subcategory: "Wooden Home Decor",
    description: "An ivory frame with a cusped arch, bordered by hand-painted red lotus and green vine motifs. The inner gold relief carving adds a soft, regal glow. It brings a breezy, garden-like feel to hallways, entryways, or above console tables. Handmade in sal wood by skilled artisans. Each floral detail is hand-painted, so every piece has its own charm.",
    price_inr: 12500,
    price_inr_export: 22500,
    variants: null,
    details: { material: "Sal Wood", finish: "Ivory with Red Lotus", size: "2 × 3 feet", craft: "Hand-painted lotus and vine border" },
    weight_g: 3000,
  ...
  // Ceramics — Vases
  {
    ...
    weight_g: 1200,
    images: ["img/nc148-1.webp", "img/nc148-2.webp"]
  },
  {
    id: 149,
